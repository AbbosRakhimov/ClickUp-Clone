...
public class AutService implements UserDetailsService {
	 ...
	 */
	public ApiResponse registerUser( RegsiterDto registerDto) {
		if(userRepo.existsByEmail(registerDto.getEmail()))
			return new ApiResponse("user with email is alread exist", false);
		...
		userRepo.save(user);
		methodeHelp.sendEmail(user.getEmail(), user.getEmailCode());
